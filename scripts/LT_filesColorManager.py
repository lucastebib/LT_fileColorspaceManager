...
filesSelectorForm = pm.formLayout('mainForm', w=350, h=400)

filesSelector = pm.textScrollList('filesSelector', allowMultiSelection=True, selectCommand=selectInTextList)

pm.formLayout('mainForm', e=True, attachForm=[ ('filesSelector', 'top', 5), ('filesSelector', 'bottom', 109), ('filesSelector', 'right', 5), ('filesSelector', 'left', 5) ])
...
pm.formLayout('mainForm', e=True, attachForm=[ ('colorspacesMenu', 'top', 5), ('colorspacesMenu', 'bottom', 84), ('colorspacesMenu', 'right', 5), ('colorspacesMenu', 'left', 5) ],
...
pm.formLayout('mainForm', e=True, attachForm=[ ('refreshButton', 'top', 5), ('refreshButton', 'bottom', 34), ('refreshButton', 'right', 5), ('refreshButton', 'left', 5), ('applyButton', 'top', 5), ('applyButton', 'bottom', 34), ('applyButton', 'right', 5), ('applyButton', 'left', 5) ],
                                           attachControl=[ ('refreshButton', 'top', 5, 'colorspacesMenu'), ('applyButton', 'top', 5, 'colorspacesMenu'), ('applyButton', 'left', 5, 'refreshButton') ],
...
artstationButton = pm.iconTextButton(st="iconOnly", command="os.startfile('https://www.artstation.com/lucastebib')", i=artstationIcon, parent=linksRow, width=24, align='right')
linkedinButton = pm.iconTextButton(st="iconOnly", command="os.startfile('https://www.linkedin.com/in/tebiblucas')", i=linkedinIcon, parent=linksRow, width=24, align='right')
gumroadBUtton = pm.iconTextButton(st="iconOnly", command="os.startfile('https://www.gumroad.com/lucastebib')", i=gumroadIcon, parent=linksRow, width=24, align='right')

pm.formLayout('mainForm', e=True, attachForm=[ ('linksRow', 'top', 5), ('linksRow', 'bottom', 5), ('linksRow', 'right', 0) ],
